...
import PusheenLogo from './../assets/pusheenLogotipo.png'
              ...
              <div className="relative max-w-xs w-full bg-white shadow-xl pb-12 flex flex-col overflow-y-auto">
                ...
                <div className="border-t border-gray-200 py-6 px-4 space-y-6">
                  ...
                  <div className="flow-root" onClick={toggleMobileSidebar}>
                    <Link to="/la-dona-gatona/">
                      <img className="h-8 w-auto" src={PusheenLogo} alt="Guitar LATAM" />
                    </Link>
                  </div>

                  <div className="flow-root" onClick={toggleMobileSidebar}>
                    <Link to="/la-dona-gatona/catalogo">
                ...
                <div className="border-t border-gray-200 py-6 px-4 space-y-6">

                  {
                    ctxUser.user?.name ?
                      ...
                      <>
                        <div className="flow-root" onClick={toggleMobileSidebar}>
                          <Link to="/la-dona-gatona/iniciar-sesion">
              ...
              <div className="h-16 flex items-center">
                ...
                <Link to="/la-dona-gatona/">
                  <div className="ml-4 mr-4 flex lg:ml-0">
                    ...
                    <img className="h-8 w-auto mr-3" src={PusheenLogo} alt="PusheenLogo" />
                    <span className="font-medium mt-1">La Dona Gatona</span>
                  ...
                  <div className="h-full flex space-x-8">
                    ...
                    <div className="flex">
                      <div className="relative flex">
                        <Link to="/la-dona-gatona/catalogo" className="border-transparent text-gray-700 hover:text-gray-800 relative z-10 flex items-center transition-colors ease-out duration-200 text-sm font-medium border-b-2 -mb-px pt-px" aria-expanded="false">
                          Catálogo de Donas
                        </Link>
                      </div>
                    </div>
                    ...
                    ctxUser.user?.name ?
                      ...
                      <>
                        <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                          <Link to="/la-dona-gatona/perfil">
                            <a href="#" className="text-sm font-medium text-gray-700 hover:text-gray-800">Mi perfil</a>
                          </Link>
                      ...
                      :
                      <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                        <Link to="/la-dona-gatona/iniciar-sesion" className="text-sm font-medium text-gray-700 hover:text-gray-800">
                          Iniciar sesión
                        </Link>
                        <span className="h-6 w-px bg-gray-200" aria-hidden="true"></span>
                        <Link to="/la-dona-gatona/crear-cuenta" className="text-sm font-medium text-gray-700 hover:text-gray-800">
                          Crear cuenta
                        </Link>
                      </div>
                  }
